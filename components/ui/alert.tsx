...
import { type TVClassValue, tv, type VariantProps } from "@/lib/utils/tv";
...
export const alertVariants = tv({
  ...
  variants: {
    variant: {
      ...
      stroke: {
        root: "bg-bg-white-0 text-text-strong-950 shadow-regular-md ring-1 ring-stroke-soft-200 ring-inset",
        closeIcon: "text-text-strong-950 opacity-40",
      },
    },
    status: {
